    ...
    public function generar()
    {
        ...
        try {
            ...
            for ($i = 0; $i < $this->num_platosEntrada; $i++) {
                $PlatosEntrada[$i] = $fabrica->crearPlatoEntrada('Lechuga'. $i, '01'. $i, 'Lechuga'. $i);
            }
            for ($i = 0; $i < $this->num_platosFondo; $i++) {
                $PlatosFondo[$i] = $fabrica->crearPlatoFondo('Porotos'. $i, '01'. $i, 'Porotos'. $i);
            }

            
            $r = array("PlatosEntrada" => $PlatosEntrada,
